                                ...
                                @foreach($submissions as $index => $submission)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('formbuilder::forms.submissions.destroy', [$form, $submission['id']]) }}" method="POST" id="deleteSubmissionForm_{{ $submission['id'] }}" class="d-inline-block">
                                                @csrf
                                                @method('DELETE')
